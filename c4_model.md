...
graph TB
    ...
    SaaS[SaaS Gestão de Serviços - CLIQUE PARA ZOOM]:::internal
    ...
    %% Interatividade (Âncora para C2)
    click SaaS "#containers-c2" "Ver Detalhes dos Containers"
...
graph TB
    ...
    %% Interatividade (Âncora para C3)
    click API "#components-c3" "Ver Detalhes dos Componentes"
...
graph TB
    ...
    %% Interatividade (Âncora para C4)
    click Billing "#code-c4" "Ver Detalhes de Código"
```
# Code (C4)
